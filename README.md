...
This plugin was tested only on Paper 1.21.4 for now, so using this plugin on older or newer versions may have bugs (Though unlikely)

Check TODO.md to see things that might come in the future.
